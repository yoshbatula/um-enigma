...
export default function About() {
  return (
    <>
      <section
        className="min-h-lvh mt-[150px] grid grid-cols-[50%_50%]
    grid-rows-[65%_35%] px-[8vw]"
      >
        ...
        max-w-[50ch]"
          ...
          <button
            className="w-[272px] min-h-[60px] flex justify-center items-center
        ...
        <div className="grid grid-cols-[50%_50%] pl-[37px] grid-rows-[20%_80%]">
          <div
            className="flex flex-col mt-[43px] leading-none col-span-2
        gap-[8px]"
          >
            <p
