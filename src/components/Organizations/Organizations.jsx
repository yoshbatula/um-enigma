...
export default function Organizations(){
  return(
    <section className=" h-fit flex flex-col gap-[12px] lg:gap-0 lg:grid lg:min-h-[68vh]  lg:grid-rows-[40%_60%] mb-[30px] px-[4vw] lg:px-[6vw]  xl:p-[30px] xl:px-[calc(8vw_+_30px)]">
