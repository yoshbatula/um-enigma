  ...
  return (
    <section className="min-h-[117vh] grid grid-rows-[67%_33%] px-[calc(8vw+30px)]">
      ...
      <div className="grid grid-cols-4">
        <div className="col-span-2 gap-[12px] p-[30px] flex flex-col justify-end">
          ...
          <p className="font-Poppins-SemiBold text-[43px] text-[#2C2C2C] leading-none">
            Resources
          </p>
          <p className="font-Poppins-Medium text-[18px] text-[#2C2C2C] opacity-70 mt-[4px]">
            Introduction to Web Development
          </p>
          <button
            className="w-fit px-[30px] py-[15px] min-h-[60px] flex justify-center items-center
        ...
        <div className="p-[30px] flex flex-col justify-end">
